...
@section('content')
    ...
    <div class="container" id="news" style="margin-bottom:150px">
        <a class="btn btn-primary" href="{{ route('tag.create') }}" role="button">Ajouter</a>
        <h1 class="mb-4">Les derniers Tag : </h1>
        @foreach ($tags as $tag)
                        ...
                        <div>
                            <div style="display: flex; flex-direction:row">
                                ...
                                <form method="post" action="{{ route('tag.destroy', $tag->id) }}">
                                    ...
                                    @csrf
                                    <button
                                        onclick="if(!confirm('Vouler-vous vraiment supprimer le Tag {{ $tag->name }}')){return false}"
